        ...
        <div className="row">
          ...
          <div className="col-md-8 col-lg-9">
            <div className="card shadow-sm p-4">
              <h1 className="mb-3">Rules for Fees</h1>
              <p>
                The school has set structured guidelines regarding fee payment to ensure smooth operations and fairness for all students.
              </p>

              {/* Fee Rules Section */}
              <h2 className="mt-4">Fee Payment Rules</h2>
              <ul className="list-group list-group-flush">
                <li className="list-group-item">School fees is charged for the complete academic year.</li>
                <li className="list-group-item">Fees should be paid till the 10th of every month.</li>
                <li className="list-group-item">Late charges of Rs. 50/- for the first day after the due date, then Rs. 5 per day.</li>
                <li className="list-group-item">No leaving certificate will be issued until all dues are cleared.</li>
                <li className="list-group-item">Notice of withdrawal must be given before March 30th.</li>
              </ul>
