        ...
        <div className="row">
          ...
          <div className="col-md-8 col-lg-9">
            <div className="card shadow-sm p-4">
              <h1 className="mb-3">General Rules</h1>
              <ul className="list-group list-group-flush">
                <li className="list-group-item">Students must respect teachers, staff, and fellow students at all times.</li>
                <li className="list-group-item">All students must wear the prescribed school uniform during school hours.</li>
                <li className="list-group-item">Students are expected to maintain discipline in classrooms, corridors, and school premises.</li>
                <li className="list-group-item">Use of mobile phones and other electronic gadgets is strictly prohibited inside the school campus.</li>
                <li className="list-group-item">Punctuality is essential, and latecomers will be subject to disciplinary action.</li>
              </ul>
