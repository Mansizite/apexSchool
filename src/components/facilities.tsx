...
//           <div className="row">
//   <div className="col-lg-8 col-12 mx-auto" style={baseTextStyle}>
...
//       />
//       <span className="position-absolute bottom-0 start-0 badge bg-primary px-3 py-2 rounded-top-end" style={{ marginLeft: '90px',width:'120px' }}>
//         {member.role}
//       </span>
//     </div>
...
//         {member.message}
//       </p>
//       <p className="fw-semibold mt-3" style={{ ...baseTextStyle }}>
//         Regards,<br />
//         {member.name}
//       </p>
//     </div>
      ...
      <section className="about section-padding" id="section_2" style={baseTextStyle}>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-8 col-12 mx-auto" style={baseTextStyle}>
              <p style={{ color: 'black' }}>
                Apex International School was founded with a vision to provide high-quality education that empowers
                students to become innovative leaders and responsible global citizens. At Apex International School, we
                believe in the holistic development of each student through academics, sports, arts, and extracurricular
                activities.
              </p>
            </div>
          </div>
            ...
            <div className="carousel-content position-relative">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  initial={{ x: direction === 'right' ? 100 : -100, opacity: 0 }}
                  animate={{ x: 0, opacity: 1, transition: { duration: 0.5, ease: 'easeInOut' } }}
                  exit={{ x: direction === 'right' ? -100 : 100, opacity: 0, transition: { duration: 0.3 } }}
                >
                  <div className="team-card-horizontal d-flex flex-column flex-md-row align-items-center p-4 shadow-lg bg-white rounded-4 border">
                    <div className="position-relative" style={{ width: '300px', height: '300px' }}>
                      <Image
                    ...
                    <div className="ms-md-4 mt-3 mt-md-0">
                      ...
                      <p className="fw-semibold mt-3" style={{ ...baseTextStyle }}>
                        Regards,<br />
                        {member.name}<br />
                        <span style={{ fontWeight: 'normal', color: '#4a5568' }}>{member.role}</span>
                      </p>
                    </div>
                  </div>
                </motion.div>
