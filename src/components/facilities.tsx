...
const AboutAndSpeakers = () => {
  ...
  return (
    <>
      ...
      {/* Our Team Section with Principal Card and Message Side-by-Side */}
      <section className="section-padding" style={{ fontFamily: 'Georgia, serif', backgroundColor: '#f2f2f2' }}>
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 mb-4 mb-md-0 d-flex justify-content-center">
              <div className="flip-card" style={{ width: '300px' }}>
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <div className="message-content">
                      <h6 className="mb-2 fw-semibold">📜 Message from the Principal</h6>
                      <p className="mb-1"><em>Dear Parents,</em></p>
                      <p className="m-0">
                        Our goal is to inspire every child to grow with confidence and reach their highest potential.
                      </p>
            ...
            <div className="col-md-6">
              <h2 className="fw-bold mb-3" style={{ color: '#1e3c72' }}>Our Team</h2>
