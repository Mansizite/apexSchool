...
//     <header>
//       {/* School Header */}
//       <div className=" py-3 border-bottom text-center" style={{fontFamily: 'Georgia, serif'}}>
...
//             />
//           </Link>
//           <h1 className="h4 m-0 text-uppercase fw-bold" style={{ fontFamily: 'Georgia, serif' }}>
...
//       {/* Bootstrap Navbar */}
//       <nav className="navbar navbar-expand-lg navbar-dark " style={{fontFamily: 'Georgia, serif',backgroundColor:'#1e3c72'}}>
    ...
    <header>
      ...
      <div className="py-0 border-bottom text-center" style={{ fontFamily: 'Georgia, serif' }}>
        <div className="d-flex flex-column flex-md-row align-items-center justify-content-center gap-3">
          ...
          <h1 className="h4 m-0 text-uppercase fw-bold" style={{color:'#1e3c72'}}>Apex International School</h1>
        </div>
      </div>
